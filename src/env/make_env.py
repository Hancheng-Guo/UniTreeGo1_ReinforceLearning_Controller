...
def make_train_env(*args, **kwargs):
    return gym.make(
        ...
        healthy_reward_weight=CONFIG["train"]["healthy_reward_weight"],
        main_body="trunk",
        healthy_z_range=(CONFIG["train"]["healthy_z_min"], CONFIG["train"]["healthy_z_max"]),
        healthy_pitch_range=(CONFIG["train"]["healthy_pitch_min"], CONFIG["train"]["healthy_pitch_max"]),
...
def make_demo_env(*args, **kwargs):
    ...
    return gym.make(
        ...
        healthy_reward_weight=CONFIG[param_type]["healthy_reward_weight"],
        main_body="trunk",
        healthy_z_range=(CONFIG[param_type]["healthy_z_min"], CONFIG[param_type]["healthy_z_max"]),
        healthy_pitch_range=(CONFIG[param_type]["healthy_pitch_min"], CONFIG[param_type]["healthy_pitch_max"]),
        include_cfrc_ext_in_observation=True,
        exclude_current_positions_from_observation=False,
